...
const std::string trkrdir = "/sphenix/lustre01/sphnxpro/mdc2/js_pp200_signal/nopileup/trkrcluster/run0021/detroit/";
const std::string calodir = "/sphenix/lustre01/sphnxpro/mdc2/js_pp200_signal/nopileup/calocluster/run0021/detroit/";
const std::string truthdir = "/sphenix/lustre01/sphnxpro/mdc2/js_pp200_signal/g4hits/run0021/detroit/";
const std::string trkrclusterfilename = "DST_TRKR_CLUSTER_pythia8_Detroit-0000000021-000000.root";
const std::string calofilename = "DST_CALO_CLUSTER_pythia8_Detroit-0000000021-000000.root";
const std::string truthfilename = "G4Hits_pythia8_Detroit-0000000021-000000.root";
// const std::string truthfilename = "G4Hits_pythia8_Detroit-0000000022-00000.root";
int Fun4All_PHYTIA_Silicon(std::string processID = "0")
{
  ...
  // std::string outDir = "/sphenix/tg/tg01/commissioning/INTT/work/mahiro/SIliconCalo/MC/dst/condor";
  // std::string outDir2 = "/sphenix/tg/tg01/commissioning/INTT/work/mahiro/SIliconCalo/MC/ana/condor";

  std::string outDir = "/sphenix/tg/tg01/commissioning/INTT/work/mahiro/SIliconCalo/MC/test/dst";
  std::string outDir2 = "/sphenix/tg/tg01/commissioning/INTT/work/mahiro/SIliconCalo/MC/test/ana";

  bool useTopologicalCluster = false;

  std::string trkrclusterfilename = "DST_TRKR_CLUSTER_pythia8_Detroit-0000000021-" + pid_str + ".root";
  std::string calofilename = "DST_CALO_CLUSTER_pythia8_Detroit-0000000021-" + pid_str + ".root";
  std::string truthfilename = "G4Hits_pythia8_Detroit-0000000021-" + pid_str + ".root";
  ...
  // outputName += "Info_" + processID + Form("_%devt", nEvents) + ".root";
  outputName += "Info_" + processID + ".root";
  // std::string outputName2 = outDir2 + "/ana_" + processID + Form("_%devt", nEvents) + ".root";
