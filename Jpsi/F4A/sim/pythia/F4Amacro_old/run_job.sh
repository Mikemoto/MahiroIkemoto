...
export SPHENIX=/sphenix/tg/tg01/commissioning/INTT/work/mahiro/jaein/INTT/general_codes/Jaein/SiliconSeeding/SiliconSeedAna
export MYINSTALL=$SPHENIX/install
source /opt/sphenix/core/bin/setup_local.sh $MYINSTALL

cd /sphenix/tg/tg01/commissioning/INTT/work/mahiro/jaein/INTT/general_codes/Jaein/SiliconSeeding/PHYTIAmacro
